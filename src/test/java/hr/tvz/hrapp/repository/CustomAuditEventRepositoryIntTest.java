package hr.tvz.hrapp.repository;

import hr.tvz.hrapp.HrApp;
import hr.tvz.hrapp.config.Constants;
import hr.tvz.hrapp.config.audit.AuditEventConverter;
import hr.tvz.hrapp.domain.PersistentAuditEvent;
...
import static hr.tvz.hrapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
